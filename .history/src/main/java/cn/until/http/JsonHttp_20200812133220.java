...
public class JsonHttp {
	...
	public String getXML(String url) {
		String body = null;
		try {
			Response document = Jsoup.connect(url).header("Accept", "*/*").header("Accept-Encoding", "gzip, deflate")
	...
	/**
	 * 
	 * @Title: getJsonInFile <p> </p> @param file 文件名，包含文件路径 @param code 编码格式 @param
	 * baseUri 该参数用于解决文件中URLs是相对路径的问题。如果不需要可以传入一个空的字符串。 @return String @throws
	 */

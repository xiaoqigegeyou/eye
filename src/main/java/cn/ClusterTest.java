...
public class ClusterTest {
	...
	public static void main(String[] args) {
		...
		// JsonObject
		// object=applicationContext.getBean(Getcluster.class).getClusterDataSource();
...
//		applicationContext.getBean(ClusterInfoService.class).insertCluster(cluster);
	...
	public void get11() {
		...
		// JsonArray applicationDataSource =
		// getappliction.getjobApplicationDataSourceByFile("apps.txt");
	}

...
public class ApplicationPO {
	...
	public String toString() {
		return "ApplicationPO [id=" + id + ", job_id=" + job_id + ", job_name=" + job_name + ", state=" + state
				+ ", product_id=" + product_id + ", satellite_name=" + satellite_name + ", job_user=" + job_user
				+ ", final_status=" + final_status + ", started_time=" + started_time + ", finished_time="
				+ finished_time + ", elapsed_time=" + elapsed_time + ", tracking_url=" + tracking_url + ", timestamp="
				+ timestamp + ", province_id=" + province_id + ", step_id=" + step_id + ", resultpath=" + resultpath
				+ ", remark=" + remark + ", orbit_no=" + orbit_no + ", scene_no=" + scene_no + "]";
	}

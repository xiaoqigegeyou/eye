...
public class CONST {
	...
	/**
	 * <p>Attempt信息页面的公共链接部分，和HTPP RESOURCEMANGER  taskid拼接处URL地址<p>
	 * URL ：<code>http://domain.com:19888/jobhistory/task/task_1546008605570_0008_m_000000</code>
	 */
	...
	/**
	 * <p>MapTask和ReduceTask的name</p>
	 */
	public static final int TASK_ID = 0;
	/**
	 * <p>MapTask和ReduceTask状态信息</p>
	 */
	public static final int TASK_STATE = 1;
	/**
	 * <p>MapTask和ReduceTask开始时间</p>
	 */
	public static final int TASK_START_TIME = 2;
	/**
	 * <p>MapTask和ReduceTask结束时间</p>
	 */
	public static final int TASK_FINISH_TIME = 3;
	/**
	 * <p>MapTask和ReduceTask运行时间</p>
	 */
	public static final int TASK_ELAPSED_TIME = 4;
	/**
	 * <p>MapTask和ReduceTask的运行节点</p>
	 */
	public static final int TASK_NODE=3;
	
	
	/***数据节点状态***/
	//NEW, RUNNING, UNHEALTHY, DECOMMISSIONING, DECOMMISSIONED, LOST, REBOOTED, SHUTDOWN
	/**
	 * 新建的数据节点
	 */
